...
<section class="page-head">
  <div>
    ...
    <h1>Trial Balance</h1>
    <p class="subhead">As of <?= date('F d, Y') ?> • All ledgers reconciled</p>
  </div>
</section>
<section class="kpi-grid three">
  <div class="kpi-card"><span>Total Debits</span><strong class="debit"><?= format_currency($tb['total_debit']) ?></strong></div>
  <div class="kpi-card"><span>Total Credits</span><strong class="credit"><?= format_currency($tb['total_credit']) ?></strong></div>
